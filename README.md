...
1. Giới thiệu
Employee Management System là ứng dụng web được xây dựng bằng ASP.NET Core MVC, cho phép quản lý thông tin nhân viên với các chức năng cơ bản như xem danh sách, xem chi tiết, thêm, sửa và xóa nhân viên.
Ứng dụng áp dụng mô hình MVC (Model – View – Controller) và kết nối SQL Server để lưu trữ dữ liệu.
2. Công nghệ sử dụng
-ASP.NET Core MVC
-.NET 8 / .NET 9
-SQL Server
